            ...
            <Box sx={{ p: { xs: 3, sm: 4 } }}>
              <Box sx={{ '& > *': { mb: 4 } }}>
                <section>
                  ...
                  >
                    By accessing or using <a href="https://iamlooper.github.io" target="_blank" rel="noopener noreferrer" style={{ color: md3.primary }}>iamlooper.github.io</a> ("Website") or any software, applications, or services provided by Looper ("we," "our," or "us"), you agree to be bound by these Terms of Service. If you do not agree to these terms, you must not use our Website or services.
                  </Typography>
                </section>

                <Divider sx={{ my: 3, borderColor: md3.outlineVariant }} />
                ...
                <section>
                  ...
                  <Box component="ul" sx={{ pl: 3 }}>
                    <Typography component="li" variant="body1" sx={{ mb: 1, color: md3.onSurfaceVariant }}>
                ...
                <section>
                  ...
                  >
                    Send notices to: <a href="mailto:dismantle@duck.com" style={{ color: md3.primary }}>dismantle@duck.com</a>. We may remove content in accordance with applicable law.
                  </Typography>
                </section>
                ...
                <section>
                  ...
                  >
                    ...
                    Email: <a href="mailto:dismantle@duck.com" style={{ color: md3.primary }}>dismantle@duck.com</a>
                  </Typography>
                </section>
              </Box>
            </Box>
